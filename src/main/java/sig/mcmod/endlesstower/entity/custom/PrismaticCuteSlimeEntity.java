...
public class PrismaticCuteSlimeEntity extends SlimeEntity {

    public PrismaticCuteSlimeEntity(EntityType<? extends SlimeEntity> entityType, World world) {
    ...
    protected void dropLoot(DamageSource source, boolean causedByPlayer) {
        ...
        if (this.random.nextFloat() < 0.01f) {this.dropItem(ModItems.PRISMATIC_SLIME_CARD);}
